...
LRESULT WINAPI ESWindowProc ( HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam ) 
{
   ...
   { 
      ...
      case WM_LBUTTONDOWN:
          {
              ...
              if (esContext && esContext->mouseFunc)
                  esContext->mouseFunc(esContext, (unsigned char)wParam, true, GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam));
          }
          break;
      ...
      case WM_LBUTTONUP:
      {
          ...
          if (esContext && esContext->mouseFunc)
              esContext->mouseFunc(esContext, (unsigned char)wParam, false, GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam));
      }
      break;
